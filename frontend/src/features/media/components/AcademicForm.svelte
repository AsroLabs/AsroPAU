...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
  <div class="flex items-center gap-3 mb-6">
    <div
      class="w-5 h-5 bg-[#2b6cee] rounded-lg flex items-center justify-center text-white"
    >
  ...
  <div class="mb-8">
    <div class="flex justify-between items-center mb-3">
      <label for="bachGrade" class="text-sm font-medium text-slate-600"
        >Media de Bachillerato (60%)</label
      >
      <span
        class="text-xs font-bold text-[#2b6cee] bg-[#2b6cee]/10 px-2 py-0.5 rounded"
        >Requerido</span
      >
    </div>
    <input
  ...
  <div class="mb-8">
    ...
    <div class="space-y-4">
      <div>
        <label for="accesoLengua" class="block text-[11px] font-bold text-slate-500 mb-1 uppercase"
          >Lengua Española y Literatura II</label
        >
        <input
          id="accesoLengua"
          type="number"
      ...
      <div>
        <label
          for="accesoHistoria"
          class="block text-[11px] font-bold text-slate-500 mb-1 uppercase"
          >Historia de España / Filosofía</label
        >
        <input
          id="accesoHistoria"
          type="number"
      ...
      <div>
        <label for="accesoIngles" class="block text-[11px] font-bold text-slate-500 mb-1 uppercase"
          >Inglés</label
        >
        <input
          id="accesoIngles"
      ...
      <div class="space-y-4 mb-4 p-4 rounded-xl border border-dashed border-slate-200">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex bg-slate-100 p-1 rounded-lg w-full">
            <button
              class="flex-1 py-1 text-xs font-medium rounded-md transition-all {subject.weight ===
              0.0
                ? 'bg-white shadow-sm text-[#2b6cee]'
                : 'text-slate-500'}"
...
<div
  class="bg-[#2b6cee]/5 rounded-xl border border-[#2b6cee]/20 p-4 flex items-start gap-3 mt-6"
>
  <Info class="text-[#2b6cee] shrink-0" size={18} />
  <p class="text-xs leading-relaxed text-slate-600">
    La nota final se calcula automáticamente sumando el 60% de tu media de Bachillerato y el 40%
    de la Fase de Acceso. La Fase de Admisión puede sumar hasta +0.4 puntos adicionales.
  </p>
</div>
