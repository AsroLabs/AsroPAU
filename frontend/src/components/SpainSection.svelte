...
>
  ...
  <div class="absolute inset-0 bg-gradient-to-br from-orange-600 via-orange-500 to-amber-400" aria-hidden="true"></div>
  ...
  <div class="absolute -bottom-20 -right-20 w-80 h-80 rounded-full bg-orange-900/20 blur-2xl pointer-events-none" aria-hidden="true"></div>
  ...
  <div class="max-w-7xl mx-auto relative z-10">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      >
        ...
        <p class="text-orange-100 text-lg mb-10 leading-relaxed max-w-md">
