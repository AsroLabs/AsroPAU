<script lang="ts">
  ...
  const allProblems: Problem[] = [
    ...
    // Matemáticas CCSS
    {
      ...
      topic: 'Álgebra',
      statement: 'Resuelve: 3x + 5 = 14.',
      solverQuery: '3*x + 5 = 14',
      difficulty: 'Fácil',
      hint: 'Despeja x restando 5 a ambos lados y dividiendo entre 3.',
      subjectColor: '#0EA5E9',
      subjectBg: '#F0F9FF',
    },
    {
    ...
    // Física
    {
      ...
      subject: 'Física',
      topic: 'Cinemática',
      statement: 'La posición de un cuerpo viene dada por x(t) = t³ − 6t² + 9t. Halla la velocidad instantánea.',
      solverQuery: 'd/dx(x**3 - 6*x**2 + 9*x)',
      difficulty: 'Medio',
      hint: 'v(t) = x\'(t). Deriva la expresión de posición.',
      subjectColor: '#7C3AED',
      subjectBg: '#F5F3FF',
    },
    {
      ...
      subject: 'Física',
      topic: 'Oscilaciones',
      statement: 'Calcula lim(x→∞) eˣ / x² para comparar crecimientos exponencial y polinomial.',
    ...
    },
    {
      ...
      statement: 'Calcula la integral ∫e^(−t) dt que aparece en la ley de velocidad de primer orden.',
...
<div class="min-h-screen bg-[#FFF7ED]">
          ...
          >
            ...
            <div class="p-5 flex flex-col flex-1">
              ...
              <a
                ...
                class="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl font-bold text-sm text-white transition-opacity duration-150 hover:opacity-85"
  ...
  <div class="max-w-5xl mx-auto px-6 py-10">
    <div
      class="relative overflow-hidden rounded-3xl p-8 md:p-10 text-white text-center"
